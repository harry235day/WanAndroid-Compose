...
class AppColors(
    ...
    var placeholder: Color by mutableStateOf(placeholder)
        private set
    var navgation: Color by mutableStateOf(navgation)
        private set
...
fun AppTheme(
    ...
    val navgation = animateColorAsState(targetColors.navgation, TweenSpec(600))
